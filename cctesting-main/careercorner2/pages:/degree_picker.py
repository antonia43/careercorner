...
def render_degree_picker():
    ...
    if not has_career_quiz_reports:
        # no reports found, forcing manual selection
        ...
        # dropdown 1 to pick report or manual
        # st.info("Load from your saved Career Quiz results:")
        ...
        if selected_report_title == "Use manual selection":
            ...
            # dropdown 2 to extract sectors from selected report
            ...
            # extracting sectors from report
            ...
            if sector_matches:
                ...
                # dropdown to pick sector from report

...
if (
    ...
    # Handle redirects before creating the widget
    ...
    if st.session_state.student_choice not in STUDENT_OPTIONS:
        st.session_state.student_choice = "Dashboard"
    ...
    choice = st.sidebar.radio(
        "Go to:",
        STUDENT_OPTIONS,
        index=STUDENT_OPTIONS.index(st.session_state.student_choice),
        key="student_choice",
    )
